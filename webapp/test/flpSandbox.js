		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Parceiros",
									"targetURL": "#z03parceiros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z03parceiros-display": {
								"semanticObject": "z03parceiros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z03.parceiros",
									"url": sap.ui.require.toUrl("z03/parceiros")
								}
							}
						}
					}
